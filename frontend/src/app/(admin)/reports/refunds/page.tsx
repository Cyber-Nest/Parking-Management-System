...
export default function RefundsAdjustmentsReport() {
  ...
  const handleExport = async () => {
    try {
      setExporting(true);
      const response = await refundsAdjustmentsService.exportReport(filters);
          ...
          <table className="w-full text-left border-collapse">
            <thead className="bg-[var(--color-surface-soft)] border-b border-[var(--color-border)]">
              <tr className="text-[10px] uppercase text-[var(--color-text-muted)] font-black tracking-widest">
                ...
                {/* <th className="px-4 sm:px-6 py-4">Processed By</th> */}
              ...
              {loading ? (
                ...
                paginatedData.map((row, idx) => (
                  ...
                  >
                    ...
                    {/* <td className="px-4 sm:px-6 py-4 text-[11px]">{row.reason}</td> */}
                    <td
                    ...
                    {/* <td className="px-4 sm:px-6 py-4 text-[11px]">{row.processedBy}</td> */}
                    <td className="px-4 sm:px-6 py-4">
