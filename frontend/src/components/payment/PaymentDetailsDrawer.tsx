          ...
          >
            ...
            <div className="p-8 border-b border-dashed border-[var(--color-border)] relative">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs font-mono text-[var(--color-text-secondary)]">Ref: {payment.transactionRef}</p>
              </div>
            ...
            <div className="flex-1 overflow-y-auto p-8 space-y-8 custom-scrollbar">
              <div className="grid grid-cols-2 gap-4">
                ...
                <InfoCard title="Processed By" value={payment.processedBy || "System"} icon={User} />
