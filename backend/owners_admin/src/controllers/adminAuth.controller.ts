...
import { UnauthorizedError, ForbiddenError, BadRequestError, ValidationError, NotFoundError } from '../services/commonErrors';
...
export const resetPassword = async (
    ...
    try {
        const { token, adminId, newPassword } = req.body as {
            token?: string;
            adminId?: string;
            newPassword?: string;
        };
...
export const getMe = async (
    req: AuthenticatedRequest,
    res: Response<ApiResponse<AdminPublic>>
): Promise<void> => {
    try {
