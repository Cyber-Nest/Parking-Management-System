...
export class PricingService {
    ...
    async create(body: { name: string; base_price: number; additional_fees?: number; tax_id?: string; is_active?: boolean }) {
    ...
    async update(id: string, body: { name?: string; base_price?: number; additional_fees?: number; tax_id?: string; is_active?: boolean }) {
