...
export declare class BookingController {
    ...
    getActiveBookings(_req: Request, res: Response): Promise<Response<any, Record<string, any>>>;
    ...
    getBookingStats(_req: Request, res: Response): Promise<Response<any, Record<string, any>>>;
    getTodayBookings(_req: Request, res: Response): Promise<Response<any, Record<string, any>>>;
}
